...
public class MainActivity extends AppCompatActivity {
    ...
    private String songNames[]={"katy_perry_e_t", "katy_perry_harleys_in_hawaii","katy_perry_teenage_dream"
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        current_song.setText(songNames[tag]);
        releaseMediaPlayer();
    ...
    private void play_next(){
        tag = (tag + 1) % songNames.length;
        playSong(tag);
    }
    private void play_previous(){
        tag = (tag - 1 + songNames.length) % songNames.length;
        playSong(tag);
    }
